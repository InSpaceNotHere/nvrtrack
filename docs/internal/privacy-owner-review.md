...
- Hosting, logging, and processors should be periodically re-audited. Current verified application host is Vercel. Current app processors also include Supabase and USDA FoodData Central for signed-in food search.
